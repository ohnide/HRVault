...
public class DismissDocumentAlertCommandHandler
    : IRequestHandler<DismissDocumentAlertCommand>
{
    private readonly IDocumentAlertRepository _repository;
    private readonly ICurrentUserService _currentUser;
    private readonly IUnitOfWork _unitOfWork;

    public DismissDocumentAlertCommandHandler(
    ...
    public async Task Handle(
        DismissDocumentAlertCommand request,
        CancellationToken cancellationToken)
    {
        ...
        alert.Status = DocumentAlertStatus.Dismissed;
