...
public class ApproveEmployeeAbsenceCommandHandler
    : IRequestHandler<ApproveEmployeeAbsenceCommand>
{
    private readonly IEmployeeAbsenceRepository _repository;
    private readonly ICurrentUserService _currentUser;
    private readonly IUnitOfWork _unitOfWork;

    public ApproveEmployeeAbsenceCommandHandler(
    ...
    public async Task Handle(
        ApproveEmployeeAbsenceCommand request,
