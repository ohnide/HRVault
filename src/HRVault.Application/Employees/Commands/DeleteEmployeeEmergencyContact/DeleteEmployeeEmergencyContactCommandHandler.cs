...
public class DeleteEmployeeEmergencyContactCommandHandler
    : IRequestHandler<DeleteEmployeeEmergencyContactCommand>
{
    ...
    public DeleteEmployeeEmergencyContactCommandHandler(
    ...
    public async Task Handle(
        DeleteEmployeeEmergencyContactCommand request,
